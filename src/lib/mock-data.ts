...
export const mockData: { [key: string]: any } = {
  ...
  customers: [
    {
      id: 'cust1',
      primaryContact: { firstName: 'Alice', lastName: 'Williams', name: 'Alice Williams', email: 'alice@example.com', phone: '123-456-7890' },
    ...
    {
      id: 'cust2',
      primaryContact: { firstName: 'Bob', lastName: 'Davis', name: 'Bob Davis', email: 'bob@example.com', phone: '234-567-8901' },
      ...
      {
      id: 'cust3',
      primaryContact: { firstName: 'Charlie', lastName: 'Miller', name: 'Charlie Miller', email: 'charlie@example.com', phone: '345-678-9012' },
  ...
  jobs: [
    {
      ...
      details: { serviceType: 'HVAC Maintenance', trade: 'HVAC', category: 'Maintenance' },
      createdAt: new Date(),
      updatedAt: new Date(),
      duration: 120,
      invoiceId: 'inv1',
    },
    {
      ...
      details: { serviceType: 'Plumbing Repair', trade: 'Plumbing', category: 'Repair' },
       createdAt: new Date(),
      updatedAt: new Date(),
      duration: 150,
      invoiceId: 'inv2',
    },
    {
      ...
      details: { serviceType: 'Electrical Inspection', trade: 'Electrical', category: 'Installation' },
      createdAt: new Date(),
      updatedAt: new Date(),
      duration: 90,
    },
     {
      ...
      details: { serviceType: 'Appliance Installation', trade: 'Plumbing', category: 'Installation' },
      createdAt: new Date(),
      updatedAt: new Date(),
      duration: 120,
      invoiceId: 'inv3',
    },
    {
      ...
      details: { serviceType: 'Network Setup', trade: 'Other', category: 'IT' },
      createdAt: new Date(),
      updatedAt: new Date(),
      duration: 120,
    },
    {
      ...
      details: { serviceType: 'Estimate', trade: 'HVAC', category: 'Sales' },
      createdAt: new Date(),
      updatedAt: new Date(),
      duration: 60,
    },
