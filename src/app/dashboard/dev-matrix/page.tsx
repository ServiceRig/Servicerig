...
const featureMatrix: Record<string, Feature[]> = {
    "Front Office": [
        ...
        { name: "Service Agreements", status: "Partial", notes: "A list view with status toggles is implemented. However, creation, editing, and automated job generation from agreements are not yet built." },
        { name: "Scheduling", status: "Implemented", notes: "Robust drag-and-drop interface for daily/weekly views. Features a 'ghost' preview for precise placement and dynamic state updates on drop." },
        { name: "Dispatch", status: "Implemented", notes: "Core functionality is handled via the scheduling board by dragging unscheduled jobs to technicians." },
        { name: "Leads", status: "Partial", notes: "A placeholder email-to-job flow exists in the backend functions, but there is no UI for lead management or tracking." },
        { name: "Call Recording", status: "Not Implemented", notes: "No functionality exists for call handling or recording." },
        { name: "Change Orders", status: "Partial", notes: "A read-only list view is implemented. Creation, editing, and linking to invoices are not yet available." },
        { name: "Estimates", status: "Implemented", notes: "Full implementation with AI Tier Generation, customer presentation view, status management, and template creation." },
        { name: "Office Timesheets", status: "Not Implemented", notes: "No UI or data structure exists for office staff timesheets." },
        { name: "Optimized Routing", status: "Partial", notes: "Technician's 'My Schedule' page can open Google Maps with an optimized route for the day's jobs. No internal route calculation or map visualization exists." },
    ],
    "Field Operations": [
        { name: "Technician App", status: "Partial", notes: "The 'My Schedule' page serves as the main mobile view. It supports viewing jobs, field purchasing, and basic navigation. Lacks full job completion workflows." },
        { name: "Inventory App", status: "Implemented", notes: "Technician can view truck stock, request parts, and log field purchases via dedicated tabs in the Inventory section." },
        { name: "Equipment History", status: "Implemented", notes: "Equipment is viewable on the customer page. Full history is available via the Equipment Log tab in the Inventory section." },
        { name: "Crew Management", status: "Not Implemented", notes: "No functionality to assign multiple technicians as a formal 'crew' to a job." },
        { name: "Dynamic Forms", status: "Not Implemented", notes: "No functionality for creating or filling out custom forms." },
        { name: "Truck Replenishment", status: "Implemented", notes: "The Shopping List is automatically generated from reorder thresholds and tech requests. A PO can be created from this list." },
        ...
        { name: "GPS Tracking", status: "Not Implemented", notes: "The map on the 'My Schedule' page is a static placeholder." },
        { name: "Purchasing", status: "Implemented", notes: "Field Purchase Dialog allows techs to log purchases on the go, creating a PO and updating truck stock." },
    ],
    "Client Experience": [
        { name: "Client Portal", status: "Implemented", notes: "A secure, token-based public link allows customers to view and print their invoices. No central login portal exists." },
        { name: "Technician Tracking", status: "Not Implemented", notes: "No 'on my way' functionality or live technician location tracking for customers." },
    ...
    "Management and Insight": [
        ...
        { name: "Purchase & Inventory", status: "Implemented", notes: "Full system for managing vendors, purchase orders, warehouse stock, truck stock, and equipment logs." },
        { name: "Project Management", status: "Not Implemented", notes: "No features for managing multi-day or complex projects with dependencies." },
        { name: "Payroll", status: "Partial", notes: "Technician Earnings report provides commission data, but this is not a full payroll system. No timeclock for hourly employees." },
        ...
        { name: "Pricebook", status: "Implemented", notes: "Full UI for managing the standard services catalog, including AI-powered price generation and manual entry." },
        { name: "Procure-To-Pay", status: "Partial", notes: "Procurement (PO system) is built. The payment side is part of the non-existent Accounting module." },
        { name: "Invoicing", status: "Implemented", notes: "Full invoicing lifecycle: manual creation, creation from jobs/estimates, detailed view with payments/refunds, public link, and edit flow for drafts." },
    ],
     "Unique Features & Strengths": [
        ...
        { name: "Integrated Field Purchasing", status: "Implemented", notes: "Technicians can log parts purchased in the field, which automatically creates a PO, updates truck stock, and makes the part available for job costing—a seamless workflow." },
        { name: "Ghosting Drag-and-Drop Schedule", status: "Implemented", notes: "The scheduling UI provides an intuitive 'ghosting' preview that shows exactly where a job will land, a significant UX improvement over simple indicators." },
    ],
};
